...
namespace Vaquinha.Unit.Tests.DomainTests
{
    ...
    public class EnderecoTests: IClassFixture<EnderecoFixture>
    {
        ...
        [Fact]
        [Trait("Endereco", "Endereco_Numero_EnderecoNumeroInvalido")]
        public void Endereco_Numero_EnderecoNumeroInvalido()
        {
            // Arrange
            ...
            // Assert
            valido.Should().BeFalse(because: "deve possuir erros de preenchimento");
            endereco.ErrorMessages.Should().HaveCount(1, because: "1 campo obrigatório foi informado incorretamente.");
            endereco.ErrorMessages.Should().Contain("O campo Número deve possuir no máximo 6 caracteres", because: "o campo numero ultrapassou tamanho máximo permitido.");
        }

        [Fact]
        [Trait("Endereco", "Endereco_Numero_EnderecoNumeroVazio")]
        public void Endereco_Numero_EnderecoNumeroVazio()
        {
            // Arrange
            var endereco = _fixture.EnderecoNumeroVazio();
            ...
            valido.Should().BeFalse(because: "deve possuir erros de preenchimento");
            endereco.ErrorMessages.Should().HaveCount(1, because: "1 campo obrigatório foi informado incorretamente.");
            endereco.ErrorMessages.Should().Contain("O campo Número deve ser preenchido", because: "o campo numero está vazio.");
        }
